            ...
            <div className="container relative z-10 px-4 md:px-6 grid lg:grid-cols-2 gap-12 text-slate-900 mt-16">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-6">
                        <Button size="lg" className="rounded-2xl h-14 md:h-16 px-8 text-lg font-bold bg-primary hover:bg-primary/90 text-white shadow-xl shadow-blue-500/20 transition-transform active:scale-95 w-full sm:w-auto">
                            <Calendar className="mr-2 h-5 w-5" />
                            Запись на прием
                        </Button>
                        <Button size="lg" variant="outline" className="rounded-2xl h-14 md:h-16 px-8 text-lg font-bold border-2 border-slate-200 bg-white/50 hover:bg-white text-slate-700 w-full sm:w-auto">
                    ...
                    <div className="flex items-center gap-4 text-sm text-slate-500 pt-8" >
                        ...
                        <p className="font-medium">Более <strong className="text-slate-900">5,000</strong> пациентов восстановлено</p>
                    </div>
                </motion.div>
