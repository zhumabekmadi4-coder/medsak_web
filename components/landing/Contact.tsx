                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="rounded-2xl overflow-hidden shadow-2xl border border-slate-700 h-[400px] relative bg-slate-800">
                        ...
                        <div className="absolute bottom-6 left-6 right-6 pointer-events-none">
                            <Button className="w-full bg-white/90 text-slate-900 hover:bg-white pointer-events-auto shadow-lg" onClick={() => window.open('https://2gis.kz/karaganda/firm/70000001081062780', '_blank')}>
                                Открыть в 2GIS
                            </Button>
                        </div>
                    </div>
